# TP Intermedio Backend: Diseño de Esquema de Base de Datos

## 1. Elección del dominio
* **Descripción de la aplicación:** Plataforma web para la gestión de una carrera de running (con distancias de 21k y 50k), donde los corredores registrados pueden consultar su perfil y visualizar una grilla interactiva con sus tiempos registrados a lo largo de las diferentes ediciones (por ejemplo: 2023, 2024, 2025 y 2026).
* **Usuarios:** Atletas / Corredores que se inscriben, gestionan sus datos y consultan su historial de rendimiento deportivo.
...
### Tipos de relaciones:
1. **Usuarios (1) $\rightarrow$ Resultados (N):** Un usuario tiene múltiples registros de participación históricos en las distintas ediciones de la carrera, pero cada resultado pertenece a un único corredor.
